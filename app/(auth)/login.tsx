// app/(auth)/login.tsx - Enhanced Login Screen with SMS/WhatsApp OTP
...
const LoginScreen: React.FC = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      router.push({
        pathname: '/(auth)/otp',
        params: { phone: phoneNumber, method: authMethod, isRegister: 'false', countryCode: countryCode,salt : response.data.salt,mobileOtpSession : response.data.mobileOtpSession,expiryTime : response.data.otpGeneratedTime}, // ✅ Pass countryCode as param
      });
    } catch (err: any) {
